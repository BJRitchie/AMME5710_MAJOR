...
# ## SCALE POINT CLOUD 
# # Scale point cloud before inputting into point cloud alignment 
...
# # Plan
# # start by cleaning point cloud of outliers etc just to check if scaling by normalisation will work 
# # Can also remove/threshold out black 