...
if mode == "SAVE":
    ...
    sfm_pipeline.make_reference_ply() # TODO Change this/change solidwork file it points to 
    sfm_pipeline.plot_reference_model()

    sfm_pipeline.resize_ims( store_path, 1200, img_interval )
    ...
    pcd = sfm_pipeline.clean_pointcloud(nb_neighbors=30, std_ratio=1.0)
    pcd = sfm_pipeline.clean_pointcloud(nb_neighbors=60, std_ratio=1)
    ...
    # Save sfm_pipeline and checkerboard classes
...
scale_factor = 0.06906822580219837 # TODO Replace with integrated function 
