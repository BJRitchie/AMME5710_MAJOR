...
# # Generate the new complex point clouds
...
# # Generate
# ref_pcd, target_pcd, gt = generate_complex_satellite_pcd()
...
# # Usage:
# ref_pcd, target_pcd, gt = generate_ppf_friendly_satellite()
...
# # Plain box/fake satellite matching with just ppf 
