...
device = pycolmap.Device.cpu #auto
...
wkspace_path = undistort_out_path
...
stereo_outpath = os.path.join(undistort_out_path, "fused.ply")
...
poisson_outpath = os.path.join(undistort_out_path, "meshed-poisson.ply")
...
delaunay_outpath = os.path.join(undistort_out_path, "meshed-delaunay.ply")
